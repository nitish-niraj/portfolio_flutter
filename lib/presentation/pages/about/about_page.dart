...
import 'package:nitish_kumar_portfolio/presentation/pages/about/widgets/about_header.dart';
import 'package:nitish_kumar_portfolio/presentation/pages/about/widgets/technology_section.dart';
...
class _AboutPageState extends State<AboutPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? bodyText2Style =
        textTheme.bodyMedium?.copyWith(color: AppColors.grey750);
